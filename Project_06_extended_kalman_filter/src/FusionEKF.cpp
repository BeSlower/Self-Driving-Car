  ...
  if (!is_initialized_) {
    ...
    */
    ...
    if (measurement_pack.SensorType == MeasurementPackage::RADAR) {
      ...
      */
      VectorXd raw_radar = measurement_pack.raw_measurements_;
      float rho = raw_radar(0);
      float theta = raw_radar(1);
      float rho_dot = raw_radar(2);
      ...
      Initialize state.
      */
      VectorXd raw_lidar = measurement_pack.raw_measurements_;
      ekf_.x_(0) = raw_lidar(0);
      ekf_.x_(1) = raw_lidar(1);
      ekf_.x_(2) = 0.0;
      ekf_.x_(3) = 0.0;
