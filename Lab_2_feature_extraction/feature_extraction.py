...
w_out = tf.Variable(tf.truncated_normal(shape=shape, mean=0, stddev=0.01))
bias_out = tf.Variable(tf.zeros(nb_classes))

logits = tf.add(tf.matmul(fc7, w_out), bias_out)
